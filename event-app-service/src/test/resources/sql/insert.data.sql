insert into sec_user (username,password,email,name,surname,gender,photo,country,city,BIO,ENABLED) VALUES('username','12345','user@gmail.com','Ivan','Ivanov','MALE',null,'Russia','SPb','user from SPb!','1');
insert into event VALUES(0,'birthday party y Ivana',0,'Party at Detsl home','Russia','SPb',null,13.12,12.56,'2015-11-15 15:00:00');
insert into commentary VALUES(0,0,0,'2016-01-20 15:00:00', 'Great!');
